...
5. Copy and paste your Flask code # Source Code
You can view the implementation here: [app.py](app.py)
6.  [(app.py)]([app.py](https://github.com/katrinalaurente/IS312-Activity-3-Basic-Web-App-Skeleton/blob/main/app.py)/app.py) into app.py.
7. Run the program.
8. Open a web browser and navigate to the local server URL (e.g., http://127.0.0.1:5000).
9. The message **"Hello World Katrina Ysabel B. Laurente"** should appear on the page.
