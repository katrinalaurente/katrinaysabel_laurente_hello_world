...
5. Copy and paste your Flask code [(app.py)](app.py/app.py) into app.py.
6. Run the program.
7. Open a web browser and navigate to the local server URL (e.g., http://127.0.0.1:5000).
8. The message **"Hello World Katrina Ysabel B. Laurente"** should appear on the page.
